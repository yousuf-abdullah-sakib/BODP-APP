...
import { confirmInvite } from "@/lib/api/auth";
...
export default function SetPasswordClient({ token }: { token: string | null }) {
  ...
  async function submit() {
    ...
    setBusy(true);
    try {
      await confirmInvite(token, newPassword);
      setSuccess(true);
    ...
    <div className="auth-wrapper" onKeyDown={onKeyDown}>
      <div className="auth-box">
        ...
        {!token ? (
          ...
          <div className="auth-success">Account activated. Redirecting you to sign in…</div>
        ) : (
          <div>
